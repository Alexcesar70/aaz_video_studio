...
2. **Dynamic Description / Descrição Dinâmica** — the ACTION of the scene as a sequence of beats, with body physics for emotion, using @id tags for characters
...
4. **Audio / Áudio** — ambient sound + every dialogue line VERBATIM. Format dialogue as \`@character: "line"\` using the character tag. If the creator did not specify dialogue, write "No dialogue. [describe ambient sounds]". If the creator wrote a dialogue in the description, preserve it EXACTLY — do not paraphrase, do not translate in EN if the original is in PT, keep it as spoken.

Example (truncated):
[
  { "lang": "pt-br", "prompt": "Estilo e Atmosfera: [visual style block]. Luz dourada de fim de tarde, tom emocional morno e expectante. Descrição Dinâmica: @abraao caminha devagar pelo quintal, o maxilar tenso. @tuba segue atrás, as orelhas baixas. No meio do caminho, @abraao para, os ombros caem. Descrição Estática: @abraao (8 anos, cabelo laranja-avermelhado bagunçado...). @tuba (cachorro médio, pelo âmbar-laranja...). Quintal do Clube da Aliança, cabana de madeira ao fundo. Áudio: Vento leve nas folhas, passos no gramado. @abraao: \\"Eu não queria ter feito isso.\\" @tuba: late baixinho uma vez." },
  { "lang": "en",    "prompt": "Style & Mood: [visual style block]. Golden late-afternoon light, warm expectant emotional tone. Dynamic Description: @abraao walks slowly through the backyard, jaw tight. @tuba follows behind, ears low. Halfway through, @abraao stops, shoulders drop. Static Description: @abraao (8 year old boy, messy orange-red hair...). @tuba (medium dog, amber-orange fur...). Clube da Aliança backyard, wooden cabin in background. Audio: Soft wind in leaves, footsteps on grass. @abraao: \\"Eu não queria ter feito isso.\\" @tuba: soft single bark." }
]

Each prompt MUST be ≤ 1800 characters. If the creator gave you dialogue, NEVER skip it from the Audio section.`
